class Solution {
    ...
    public ListNode addTwoNumbers(ListNode l1, ListNode l2) {
        ...
        for (int i = 0; i < l1Length; i++) { //fill massive
            mas1[i] = l1.val;
            l1 = l1.next;
        }
        ...
        for (int i = l1Length, k = 0; k < l1Length; i--, k++) { //make number from list
    ...
    public static void main(String[] args) {
        ListNode num1 = makeList(0); //create two linked list
        ListNode num2 = makeList(0);
